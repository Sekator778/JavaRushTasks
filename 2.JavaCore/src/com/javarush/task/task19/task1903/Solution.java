...
/* 
Адаптация нескольких интерфейсовАдаптация нескольких интерфейсов
...
//            }
//            return null;
            return countries.get(data.getCountryCode());// риали ми вертаем с мапи по ключу
        }
        ...
        public String getPhoneNumber() {
            String phone = String.format("%010d",data.getPhoneNumber()); // формат поля телефон ниже туда запихиваем инфу
