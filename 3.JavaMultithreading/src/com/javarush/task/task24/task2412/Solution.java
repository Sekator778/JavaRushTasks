...
public class Solution {
    ...
    public static void sort(List<Stock> list) {
        ...
        list.sort(new Comparator<Stock>() {
            ...
            public int compare(Stock stock1, Stock stock2) {
                ...
                int nameComporator = name1.compareTo(name2);

                if (nameComporator != 0) {
                    return nameComporator;
                }
                else {
    ...
    public static List<Stock> getStocks() {
        ...
        stocks.add(new Stock("Fake Nokia Corporation (ADR)", "NOK", .2, new Date(1000)));
        stocks.add(new Stock("Fake Nokia Corporation (ADR)", "NOK", -.1, new Date(1000)));
